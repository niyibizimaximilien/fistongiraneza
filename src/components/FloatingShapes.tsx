const FloatingShapes = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {/* Large morphing blob */}
      <div 
        className="absolute -top-20 -right-20 w-96 h-96 bg-muted/30 animate-morph"
      ...
      />
      <div 
        className="absolute top-1/3 right-20 w-6 h-6 rounded-full bg-muted animate-float"
      ...
      {/* Gradient orb */}
      <div className="absolute bottom-20 right-10 w-24 h-24 rounded-full bg-gradient-to-br from-muted to-transparent animate-pulse-glow" />
